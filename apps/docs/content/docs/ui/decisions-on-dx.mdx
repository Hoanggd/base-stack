...
When you start using the base-stack, you might have some of the following questions:

> Why use a monorepo?

> Why choose shadcn?

> Why do some components, especially form components, seem a bit verbose to use?

> If we use shadcn, why are most of its components replaced?

> Why not use Redux, Redux Thunk, or Saga?
...
## Why do some shadcn components, especially form components, seem a bit verbose to use?
...
You can read more about this [here](http://localhost:9009/docs/ui/philosophy#2-avoid-hasty-abstractions).
